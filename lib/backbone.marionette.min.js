...
(function (e, t) {
	...
	(function (e, t) {
		...
		return (
					...
					remove: function (e) {
						...
						return (
							...
							t.any(
								...
								function (e, t) {
									return e === i
										? (delete this._indexByCustom[t], !0)
										: void 0;
								},
								this
							),
			...
			(e.ChildViewContainer.VERSION = "0.1.5"),
	...
	(r.VERSION = "2.3.2"),
		...
		(r.normalizeUIValues = function (e, t) {
			return (
				i.each(e, function (n, s) {
					i.isString(n) && (e[s] = r.normalizeUIString(n, t));
				}),
				e
			);
		}),
	...
	var s = (r.deprecate = function (e, t) {
		i.isObject(e) &&
			(e =
				e.prev +
	...
	(s._warn =
		...
		(r._triggerMethod = (function () {
			...
			return function (n, r, s) {
				...
				var h,
					...
					l = n[a];
				return (
					i.isFunction(l) && (h = l.apply(n, o ? i.rest(s) : s)),
					i.isFunction(n.trigger) &&
						(o + s.length > 1
							? n.trigger.apply(
									n,
									o ? s : [r].concat(i.rest(s, 0))
							  )
							: n.trigger(r)),
					h
				);
		...
		(r.triggerMethodOn = function (e) {
			var t = i.isFunction(e.triggerMethod)
				? e.triggerMethod
				: r.triggerMethod;
	...
	return (
		...
		i.extend(r.Controller.prototype, t.Events, {
			destroy: function () {
				return (
					r._triggerMethod(this, "before:destroy", arguments),
		...
		(r.Object = function (e) {
			(this.options = i.extend({}, i.result(this, "options"), e)),
				this.initialize.apply(this, arguments);
		}),
		(r.Object.extend = r.extend),
		i.extend(r.Object.prototype, t.Events, {
			initialize: function () {},
			destroy: function () {
		...
		(r.Region = r.Object.extend(
			{
				constructor: function (e) {
					if (
						...
						(this.el =
							this.el instanceof t.$ ? this.el[0] : this.el),
						!this.el)
					)
						throw new r.Error({
							name: "NoElError",
					...
					if (this._ensureElement()) {
						...
						if (
							...
							e.once("destroy", this.empty, this),
								...
								r.triggerMethodOn(e, "before:show", e, this, t),
								h &&
									this.triggerMethod(
										"swapOut",
										this.currentView,
							...
							var u = r.isNodeAttached(this.el),
								...
								c =
									...
									this.triggerBeforeAttach,
								g = i.triggerAttach || this.triggerAttach;
							return (
								u &&
									c &&
									((d = this._displayedViews(e)),
								...
								h && this.triggerMethod("swap", e, this, t),
								this.triggerMethod("show", e, this, t),
								r.triggerMethodOn(e, "show", e, this, t),
								this
							);
						}
						return this;
				...
				_destroyView: function () {
					...
					e.destroy && !e.isDestroyed
						? e.destroy()
						: e.remove && (e.remove(), (e.isDestroyed = !0));
				},
		...
		(r.RegionManager = r.Controller.extend({
			constructor: function (e) {
				(this._regions = {}),
					r.Controller.call(this, e),
					this.addRegions(this.getOption("regions"));
			},
			addRegions: function (e, t) {
				return (
					(e = r._getValue(e, this, arguments)),
					i.reduce(
						e,
						function (e, n, r) {
							return (
								i.isString(n) && (n = { selector: n }),
								n.selector && (n = i.defaults({}, n, t)),
								(e[r] = this.addRegion(r, n)),
								e
							);
						},
						{},
			...
			addRegion: function (e, t) {
				...
				return (
					(i =
						t instanceof r.Region
							? t
							: r.Region.buildRegion(t, r.Region)),
					this.triggerMethod("before:add:region", e, i),
					(i._parent = this),
					this._store(e, i),
					this.triggerMethod("add:region", e, i),
					i
				);
			},
			get: function (e) {
		...
		(r.View = t.View.extend({
				...
				if (!this.isDestroyed) {
					...
					return (
						this.triggerMethod.apply(
							this,
							["before:destroy"].concat(e)
						),
						(this.isDestroyed = !0),
						this.triggerMethod.apply(this, ["destroy"].concat(e)),
						this.unbindUIElements(),
						this.remove(),
						i.invoke(this._behaviors, "destroy", e),
						this
					);
				}
			},
			...
			setElement: function () {
				...
				return (
					i.invoke(this._behaviors, "proxyViewProperties", this), e
				);
			},
			triggerMethod: function () {
				for (
					var e = r._triggerMethod,
						t = e(this, arguments),
						i = this._behaviors,
						n = 0,
						s = i && i.length;
		...
		(r.CollectionView = r.View.extend({
			...
			constructor: function (e) {
				var t = e || {};
				i.isUndefined(this.sort) &&
					(this.sort = i.isUndefined(t.sort) ? !0 : t.sort),
			...
			_triggerBeforeShowBufferedChildren: function () {
				this._isShown &&
					i.each(
						this._bufferedChildren,
						i.partial(this._triggerMethodOnChild, "before:show")
					);
			},
			_triggerShowBufferedChildren: function () {
				this._isShown &&
					(i.each(
						this._bufferedChildren,
						i.partial(this._triggerMethodOnChild, "show")
					),
					(this._bufferedChildren = []));
			},
			...
			addEmptyView: function (e, t) {
				...
				var s = this.buildChildView(e, t, n);
				(s._parent = this),
					this.proxyChildEvents(s),
					this._isShown && r.triggerMethodOn(s, "before:show"),
					this.children.add(s),
					this.renderChildView(s, this._emptyViewIndex),
					this._isShown && r.triggerMethodOn(s, "show");
			},
			...
			removeChildView: function (e) {
				return (
					e &&
						...
						e.destroy ? e.destroy() : e.remove && e.remove(),
						delete e._parent,
			...
			attachHtml: function (e, t, i) {
				e.isBuffering
					...
					: e._insertBefore(t, i) || e._insertAfter(t);
			},
			_insertBefore: function (e, t) {
				var i,
					n = this.sort && this.children.length - 1 > t;
				return (
					n &&
						(i = this.children.find(function (e) {
							return e._index === t + 1;
						})),
				...
				this.listenTo(
					...
					function () {
						var n = i.toArray(arguments),
							r = n[0],
							s = this.normalizeMethods(
								i.result(this, "childEvents")
							);
						(n[0] = t + ":" + r),
							n.splice(1, 0, e),
							s !== void 0 &&
								i.isFunction(s[r]) &&
								s[r].apply(this, n.slice(1)),
		...
		(r.CompositeView = r.CollectionView.extend({
			...
			getChildViewContainer: function (e) {
				...
				var t,
					i = r.getOption(e, "childViewContainer");
				if (i) {
		...
		(r.LayoutView = r.ItemView.extend({
			...
			destroy: function () {
				return this.isDestroyed
					...
					: (this.regionManager.destroy(),
					  r.ItemView.prototype.destroy.apply(this, arguments));
			},
			addRegion: function (e, t) {
				var i = {};
			...
			_initializeRegions: function (e) {
				...
				this._initRegionManager(),
					(t = r._getValue(this.regions, this, [e]) || {});
				var n = this.getOption.call(e, "regions");
				(n = r._getValue(n, this, [e])),
					i.extend(t, n),
					(t = this.normalizeUIValues(t)),
					this.addRegions(t);
			},
			...
			var r = /^(\S+)\s*(.*)$/,
				s = {
					...
					behaviorEvents: function (i, n) {
						var s = {},
							o = this._uiBindings || t.result(this, "ui");
						return (
							t.each(
								n,
								function (i, n) {
				...
				t.extend(n.prototype, {
					...
					_buildTriggerHandlersForBehavior: function (i, n) {
						var r = t.extend({}, this._viewUI, t.result(i, "ui")),
							s = t.clone(t.result(i, "triggers")) || {};
						(s = e.normalizeUIKeys(s, r)),
							t.each(
								s,
								t.bind(this._setHandlerForBehavior, this, i, n)
							);
					},
		...
		(r.AppRouter = t.Router.extend({
			...
			_addAppRoute: function (e, t, n) {
				...
				if (!s)
					throw new r.Error(
						'Method "' + n + '" was not found on the controller'
					);
		...
		(r.Application = r.Object.extend({
			...
			_initializeRegions: function (e) {
				var t = i.isFunction(this.regions)
					? this.regions(e)
					: this.regions || {};
				this._initRegionManager();
				var n = r.getOption(e, "regions");
				return (
					i.isFunction(n) && (n = n.call(this, e)),
					i.extend(t, n),
					this.addRegions(t),
					this
				);
			...
			_initChannel: function () {
				(this.channelName = i.result(this, "channelName") || "global"),
					(this.channel =
						i.result(this, "channel") ||
						t.Wreqr.radio.channel(this.channelName)),
					(this.vent = i.result(this, "vent") || this.channel.vent),
					(this.commands =
						i.result(this, "commands") || this.channel.commands),
					(this.reqres =
						i.result(this, "reqres") || this.channel.reqres);
			}
		})),
		(r.Module = function (e, t, n) {
			(this.moduleName = e),
				...
				(this.app = t),
				i.isFunction(this.initialize) &&
					this.initialize(e, t, this.options);
		}),
		(r.Module.extend = r.extend),
		i.extend(r.Module.prototype, t.Events, {
			startWithParent: !0,
			initialize: function () {},
			addInitializer: function (e) {
			...
			_runModuleDefinition: function (e, n) {
				if (e) {
					var s = i.flatten([this, this.app, t, r, t.$, i, n]);
					e.apply(this, s);
				}
			},
		...
		i.extend(r.Module, {
			...
			_addModuleDefinition: function (e, t, i, n) {
				var r = this._getDefine(i),
					s = this._getStartWithParent(i, t);
				r && t.addDefinition(r, n), this._addStartWithParent(e, t, s);
			},
			_getStartWithParent: function (e, t) {
				var n;
				return i.isFunction(e) && e.prototype instanceof r.Module
					? ((n = t.constructor.prototype.startWithParent),
					  i.isUndefined(n) ? !0 : n)
					: i.isObject(e)
					? ((n = e.startWithParent), i.isUndefined(n) ? !0 : n)
					: !0;
			},
