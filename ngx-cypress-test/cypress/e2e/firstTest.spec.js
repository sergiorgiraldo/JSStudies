...
describe("Our first suite", () => {
	...
	it("then and wrap methods", () => {
		...
		cy.contains("nb-card", "Using the Grid").then((firstForm) => {
			...
			cy.contains("nb-card", "Basic form").then((secondForm) => {
				const emailLabelSecond = secondForm.find(
	...
	it("assert property", () => {
		...
		cy.contains("nb-card", "Common Datepicker")
			...
			.then((input) => {
				...
				cy.wrap(input)
					.invoke("prop", "value")
					.should("contain", dateAssert); //prop is the object name for the properties
	...
	it.only('dialog box', () => {
        ...
        // }) <- this is not a good way because if there is no confirm windows, the on event wont fire and the assert will not be called (and also not an error)
