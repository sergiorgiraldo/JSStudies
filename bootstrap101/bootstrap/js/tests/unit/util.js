$(function () {
	...
	QUnit.test(
		...
		function (assert) {
			...
			var $el = $('<div data-target="#1"></div>').appendTo(
				$("#qunit-fixture")
			);
	...
	QUnit.test(
		...
		function (assert) {
			...
			assert.strictEqual(
				Util.getTransitionDurationFromElement($div[0]),
				300
			);
		}
	);
	...
	QUnit.test(
		...
		function (assert) {
			...
			assert.strictEqual(
				Util.getTransitionDurationFromElement($div2[0]),
				280
			);
		}
	);
	...
	QUnit.test(
		...
		function (assert) {
			...
			assert.equal(
				shadowRoot,
				Util.findShadowRoot(shadowRoot.firstChild)
			);
		}
	);
