	...
	return function (t) {
		function h(t) {
			(t.icon = t.hasOwnProperty("icon") ? t.icon : ""),
				...
				(t.placement = t.hasOwnProperty("placement")
					? t.placement
					: "right"),
				(t.ariaLabel = t.hasOwnProperty("ariaLabel")
					? t.ariaLabel
					: "Anchor"),
		...
		(this.options = t || {}),
			...
			(this.hasAnchorJSLink = function (t) {
				var e =
						t.firstChild &&
						-1 <
							(" " + t.firstChild.className + " ").indexOf(
								" anchorjs-link "
							),
					n =
						t.lastChild &&
						-1 <
							(" " + t.lastChild.className + " ").indexOf(
								" anchorjs-link "
							);
				return e || n || !1;
			});
