		...
		elyg: function (e, t, r) {
			...
			function A(e, t) {
				return fetch(e, { credentials: "same-origin" }).then(function (
					...
					if (!r.ok) {
						if (t > 1 && r.status >= 500) return A(e, t - 1);
						if (404 === r.status)
								...
								if (t.__N) {
									...
									(i.isSsr &&
										...
										i.change(
											...
											Object.assign({}, a, {
												shallow:
													a.shallow && i._shallow,
												locale:
													a.locale || i.defaultLocale
											}),
											undefined
										);
								}
