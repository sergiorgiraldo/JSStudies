			...
			(function (t) {
				!(function () {
					...
					var Ht =
						...
						Jt = Array.prototype;
					null == Jt[Yt] &&
						I.f(Jt, Yt, { configurable: !0, value: Ht(null) });
					var Qt = function (t) {
						Jt[Yt][t] = !0;
					};
					...
					Lt(
						{ target: "Reflect", stat: !0, forced: oo, sham: oo },
						{
							construct: function (t, e) {
								Zt(t), j(e);
								var r =
									arguments.length < 3 ? t : Zt(arguments[2]);
					...
					var Oi,
						...
						Pi =
							...
							((ji = /[ac]/).exec = function () {
								return (
									(Oi = !0), /./.exec.apply(this, arguments)
								);
							}),
							!0 === ji.test("abc") && Oi),
						Ii = /./.test;
					...
					Ra.prototype[Sa] ||
						T(Ra.prototype, Sa, Ra.prototype.valueOf),
						Ne(Ra, wa),
						(X[ba] = !0),
						ya("asyncIterator");
					var Xa = I.f,
					...
					(Xc && Hc) ||
						...
						"process" == h(Yc)
							...
							: ((zc = of),
							  o.addEventListener("message", nf, !1)));
					var af,
						uf,
						sf,
						cf,
								...
								Lt(
									{ global: !0, enumerable: !0, forced: !0 },
									{
										fetch: function (t) {
											return Tf(
												Ff,
												zf.apply(o, arguments)
											);
										}
									}
								))),
						Lt(
							{ global: !0, wrap: !0, forced: Xf },
							{ Promise: Ff }
						),
						Ne(Ff, _f, !1),
						qr(_f),
					...
					(wl.prototype.append = function (t, e) {
						...
						(wl.prototype.get = function (t) {
							return (
								(t = yl(t)), this.has(t) ? this.map[t] : null
							);
						}),
						...
						ll &&
							(wl.prototype[Symbol.iterator] =
								wl.prototype.entries);
					var Ol = [
						"DELETE",
						"GET",
						"HEAD",
