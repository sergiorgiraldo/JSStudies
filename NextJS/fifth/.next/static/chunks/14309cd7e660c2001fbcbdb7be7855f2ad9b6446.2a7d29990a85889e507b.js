			...
			(e.__esModule = !0),
				(e.formatUrl = function (t) {
					var e = t.auth,
						...
						s = !1;
					(e = e
						? encodeURIComponent(e).replace(/%3A/i, ":") + "@"
						: ""),
						t.host
							? (s = e + t.host)
							: r &&
		...
		Nh2W: function (t, e, r) {
			...
			function d(t, e) {
				return p().then(function (r) {
					if (!(e in r))
						throw f(
							new Error("Failed to lookup route: ".concat(e))
						);
		...
		elyg: function (t, e, r) {
			...
			function x(t) {
				var e = t.indexOf("?"),
					r = t.indexOf("#");
				return (
					(e > -1 || r > -1) && (t = t.substring(0, e > -1 ? e : r)),
					t
				);
			}
			function P(t) {
				...
				return (function (t, e) {
					return e && t.startsWith("/")
						? "/" === t
							...
							: ""
									.concat(e)
									.concat("/" === x(t) ? t.substring(1) : t)
						: t;
				})(t, "");
			}
			function k(t) {
				return (
					(t = t.slice("".length)).startsWith("/") ||
						(t = "/".concat(t)),
					t
				);
			}
			...
			function I(t, e) {
				return fetch(t, { credentials: "same-origin" }).then(function (
					r
				) {
					if (!r.ok) {
		...
		"g/15": function (t, e, r) {
			...
			(e.__esModule = !0),
				(e.execOnce = function (t) {
					...
					return function () {
						return (
							r || ((r = !0), (e = t.apply(void 0, arguments))), e
						);
					};
				}),
